...
class MainController extends Controller
{
    ...
    {
        $this->design->assign('banners_slider', $this->bannerDBRepository->getVisible());
        $this->design->assign('new_products', $this->productDBRepository->getProducts('new'));
        $this->design->assign('featured_products' , $this->productDBRepository->getProducts('features'));
        $this->design->assign('posts' , $this->blogDBRepository->getPosts());
        $this->design->assign('discounted_products' , $this->productDBRepository->getProducts('discount'));
